package at.petrak.hexlite.server;

import at.petrak.hexlite.api.casting.ActionRegistryEntry;
import at.petrak.hexlite.api.casting.math.EulerPathFinder;
...
public class ScrungledPatternsSave extends SavedData {
    ...
    public static final String TAG_SAVED_DATA = "hexlite.per-world-patterns." + DATA_VERSION;
