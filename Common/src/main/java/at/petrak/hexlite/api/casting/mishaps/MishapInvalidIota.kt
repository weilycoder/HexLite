...
class MishapInvalidIota(
    ...
    override fun errorMessage(ctx: CastingEnvironment, errorCtx: Context): Component? {
        ...
        var perpDesc = Component.translatableWithFallback("hexlite.iota.${perpKey}.desc", "no desc found")
        ...
        if (perpDesc.getString() == "no desc found")
            perpDesc = Component.translatable("hexlite.mishap.invalid_value.class.${perpKey?.getPath()}")
    ...
    companion object {
        ...
        fun of(perpetrator: Iota, reverseIdx: Int, name: String, vararg translations: Any): MishapInvalidIota {
            val key = "hexlite.mishap.invalid_value.$name"
