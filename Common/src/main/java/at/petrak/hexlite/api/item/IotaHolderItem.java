package at.petrak.hexlite.api.item;
...
public interface IotaHolderItem {
     ...
     * {@link at.petrak.hexlite.api.casting.iota.IotaType IotaType} given by the resource location.
     * <p>
    ...
    static void appendHoverText(IotaHolderItem self, ItemStack stack, List<Component> components,
        ...
        if (datumTag != null) {
            ...
            components.add(Component.translatable("hexlite.spelldata.onitem", cmp));
            ...
            components.add(Component.translatable("hexlite.spelldata.onitem",
                Component.translatable("hexlite.spelldata.anything").withStyle(ChatFormatting.LIGHT_PURPLE)));
        }
    }
}
