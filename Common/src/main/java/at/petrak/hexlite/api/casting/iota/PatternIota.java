package at.petrak.hexlite.api.casting.iota;

import at.petrak.hexlite.api.HexAPI;
import at.petrak.hexlite.api.casting.ActionRegistryEntry;
import at.petrak.hexlite.api.casting.PatternShapeMatch;
...
import at.petrak.hexlite.api.casting.mishaps.MishapEvalTooMuch;
import at.petrak.hexlite.api.casting.mishaps.MishapInvalidPattern;
import at.petrak.hexlite.api.casting.mishaps.MishapUnenlightened;
...
import static at.petrak.hexlite.api.utils.HexUtils.isOfTag;
...
public class PatternIota extends Iota {
    ...
    public static Component displayNonInline(HexPattern pat){
        ...
        return Component.translatable("hexlite.tooltip.pattern_iota",
