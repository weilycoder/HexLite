package at.petrak.hexlite.interop;

import at.petrak.hexlite.interop.inline.InlineHex;
import at.petrak.hexlite.interop.inline.InlineHexClient;
...
public class HexInterop {
    public static final String PATCHOULI_ANY_INTEROP_FLAG = "hexlite:any_interop";
