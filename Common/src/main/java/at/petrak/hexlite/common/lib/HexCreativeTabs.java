...
public class HexCreativeTabs {
    ...
    public static final CreativeModeTab HEX = register("hexlite", CreativeModeTab.builder(CreativeModeTab.Row.TOP, 7)
    ...
    private static CreativeModeTab register(String name, CreativeModeTab.Builder tabBuilder) {
        var tab = tabBuilder.title(Component.translatable("itemGroup.hexlite." + name)).build();
