...
import at.petrak.hexlite.api.utils.MathUtils;
import at.petrak.hexlite.api.utils.MediaHelper;
...
public abstract class ItemMediaHolder extends Item implements MediaHolderItem {
    public static final String TAG_MEDIA = "hexlite:media";
    public static final String TAG_MAX_MEDIA = "hexlite:start_media";
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents,
        ...
        if (maxMedia > 0) {
            ...
            var maxCapacity = Component.translatable("hexlite.tooltip.media", DUST_AMOUNT.format(maxMedia / (float) MediaConstants.DUST_UNIT));
            ...
            pTooltipComponents.add(
                Component.translatable("hexlite.tooltip.media_amount.advanced",
