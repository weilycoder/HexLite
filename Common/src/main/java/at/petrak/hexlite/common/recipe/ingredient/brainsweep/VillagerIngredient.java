package at.petrak.hexlite.common.recipe.ingredient.brainsweep;
...
public class VillagerIngredient extends BrainsweepeeIngredient {
    ...
    public List<Component> getTooltip(boolean advanced) {
        ...
        if (advanced) {
            if (minLevel >= 5) {
                tooltip.add(Component.translatable("hexlite.tooltip.brainsweep.level", 5)
                    .withStyle(ChatFormatting.DARK_GRAY));
            } else if (minLevel > 1) {
                tooltip.add(Component.translatable("hexlite.tooltip.brainsweep.min_level", minLevel)
                    .withStyle(ChatFormatting.DARK_GRAY));
            }
