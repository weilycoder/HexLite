...
public class ItemSpellbook extends Item implements IotaHolderItem, VariantItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip,
        ...
        if (NBTHelper.hasNumber(stack, TAG_SELECTED_PAGE)) {
            ...
            if (highest != 0) {
                if (sealed) {
                    tooltip.add(Component.translatable("hexlite.tooltip.spellbook.page.sealed",
                    ...
                    tooltip.add(Component.translatable("hexlite.tooltip.spellbook.page",
                            Component.literal(String.valueOf(pageIdx)).withStyle(ChatFormatting.WHITE),
                            Component.literal(String.valueOf(highest)).withStyle(ChatFormatting.WHITE))
                        .withStyle(ChatFormatting.GRAY));
                }
        ...
        if (empty) {
            ...
            if (sealed) {
                if (overridden) {
                    tooltip.add(Component.translatable("hexlite.tooltip.spellbook.sealed").withStyle(
                        ChatFormatting.GOLD));
                } else {
                    tooltip.add(Component.translatable("hexlite.tooltip.spellbook.empty.sealed",
                            Component.translatable("hexlite.tooltip.spellbook.sealed").withStyle(ChatFormatting.GOLD))
                        .withStyle(ChatFormatting.GRAY));
                }
            } else if (!overridden) {
                tooltip.add(
                    Component.translatable("hexlite.tooltip.spellbook.empty").withStyle(ChatFormatting.GRAY));
            }
        }
