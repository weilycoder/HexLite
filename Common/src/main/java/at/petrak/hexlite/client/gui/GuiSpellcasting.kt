package at.petrak.hexlite.client.gui
...
import at.petrak.hexlite.api.casting.math.HexAngle
...
import at.petrak.hexlite.client.ClientTickCounter
import at.petrak.hexlite.client.ShiftScrollListener
import at.petrak.hexlite.client.ktxt.accumulatedScroll
import at.petrak.hexlite.client.render.*
import at.petrak.hexlite.client.sound.GridSoundInstance
import at.petrak.hexlite.common.lib.HexAttributes
import at.petrak.hexlite.common.lib.HexSounds
import at.petrak.hexlite.common.msgs.MsgNewSpellPatternC2S
...
) : Screen("gui.hexlite.spellcasting".asTranslatedComponent) {
...
//        }
    ...
    fun coordToPx(coord: HexCoord) =
        at.petrak.hexlite.api.utils.coordToPx(coord, this.hexSize(), this.coordsOffset())

    fun pxToCoord(px: Vec2) = at.petrak.hexlite.api.utils.pxToCoord(px, this.hexSize(), this.coordsOffset())
