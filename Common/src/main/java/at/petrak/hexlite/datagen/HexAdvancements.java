...
import at.petrak.hexlite.api.advancements.FailToCastGreatSpellTrigger;
import at.petrak.hexlite.api.advancements.MinMaxLongs;
import at.petrak.hexlite.api.advancements.OvercastTrigger;
import at.petrak.hexlite.api.advancements.SpendMediaTrigger;
    ...
    public void generate(HolderLookup.Provider provider, Consumer<Advancement> consumer) {
        var root = Advancement.Builder.advancement()
            ...
            .display(new DisplayInfo(new ItemStack(Items.BUDDING_AMETHYST),
                Component.translatable("advancement.hexlite:root"),
                Component.translatable("advancement.hexlite:root.desc"),
        ...
        Advancement.Builder.advancement()
            .display(new DisplayInfo(new ItemStack(HexItems.CREATIVE_UNLOCKER),
                Component.translatable("advancement.hexlite:creative_unlocker"),
                Component.translatable("advancement.hexlite:creative_unlocker.desc"),
                new ResourceLocation("minecraft", "textures/block/calcite.png"),
        ...
        Advancement.Builder.advancement()
            .display(new DisplayInfo(new ItemStack(Items.MUSIC_DISC_11),
                Component.translatable("advancement.hexlite:enlightenment"),
                Component.translatable("advancement.hexlite:enlightenment.desc"),
                null,
