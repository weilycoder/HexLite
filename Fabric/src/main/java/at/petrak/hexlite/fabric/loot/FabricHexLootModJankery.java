package at.petrak.hexlite.fabric.loot;

import at.petrak.hexlite.common.lib.HexItems;
import at.petrak.hexlite.common.loot.AddPerWorldPatternToScrollFunc;
import at.petrak.hexlite.common.loot.AddHexToAncientCypherFunc;
import at.petrak.hexlite.fabric.FabricHexInitializer;
...
import static at.petrak.hexlite.common.loot.HexLootHandler.TABLE_INJECT_AMETHYST_CLUSTER;
