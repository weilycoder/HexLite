...
public class ServerPlayerInteractionManagerMixin
{
	...
	@ModifyArg(method = "handleBlockBreakAction", index = 0, at = @At(value = "INVOKE", target = "Lnet/minecraft/world/phys/Vec3;distanceToSqr(Lnet/minecraft/world/phys/Vec3;)D"))
	private Vec3 pehkui$processBlockBreakingAction$center(Vec3 center)
	{
